...
Um **comportamento indefinido** é aquele cujo o *standard* não **impõem** nada sobre seu resultado. Note que isso é diferente de dizer que o *standard* impõe um resultado dentre valores especificados.
